/*! nouislider - 14.1.1 - 12/15/2019 */ !(function(t) {
    ...
    function o(t, e, r) {
        ...
        if (!i((n = "min" === t ? 0 : "max" === t ? 100 : parseFloat(t))) ||
            !i(e[0])
        )
    ...
    function l(t, e, r) {
        ...
        for (
            ...
            o(i[n][1], i[n][0], this);
        for (
            this.xNumSteps = this.xSteps.slice(0), n = 0; n < this.xNumSteps.length; n++
        )
    ...
    function x(t, e) {
        var r,
            n = [!1];
        if (
            ("lower" === e ? (e = [!0, !1]) : "upper" === e && (e = [!1, !0]), !0 === e || !1 === e)
        ) {
    ...
    function C(t, e) {
        ...
        if (0 !== e) {
            if (
                (Array.isArray(e) || (e = [e, e]), !(t.padding = [
    ...
    function D(t, v, o) {
            ...
            var m,
                ...
                ((m = i),
                    ...
                    v.forEach(function(t, e) {
                        ...
                        if (
                            (h && (r = y.xNumSteps[e]),
                                r || (r = d - f), !1 !== f && void 0 !== d)
                        )
                            for (
                                r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1
                            ) {
                                for (
                                ...
                                (l = -1 < v.indexOf(n) ? P : h ? V : U), !e && S && (l = 0),
        ...
        function Y(t, e) {
            if (-1 === navigator.appVersion.indexOf("MSIE 9") &&
                0 === t.buttons &&
                0 !== e.buttonsProperty
            )
                return _(t, e);
        ...
        function K(t, e, r, n, i, o) {
            return (
                ...
                (0 === e && (r = Math.max(r, v.padding[0])),
                    e === u.length - 1 && (r = Math.min(r, 100 - v.padding[1]))), !((r = ft((r = y.getStep(r)))) === t[e] && !o) && r
            );
        }
        ...
        function it(t, e) {
            return null === t || !1 === t || void 0 === t ?
                ...
                ("number" == typeof t && (t = String(t)),
                    (t = v.format.from(t)), !1 === (t = y.toStepping(t)) || isNaN(t) ? S[e] : t);
        }
        ...
        function st(t) {
            ...
            return (
                ...
                null !== o && !1 !== o && (o = Number(o.toFixed(a))), [o, i]
            );
        }
        return (
