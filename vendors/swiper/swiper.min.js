...
!(function(e, t) {
    ...
    var d = {
            ...
            extend: function() {
                ...
                for (var i = Object(e[0]), s = 1; s < e.length; s += 1) {
                    ...
                    if (null != a)
                        for (
                            var r = Object.keys(Object(a)), n = 0, o = r.length; n < o; n += 1
                        ) {
                            var l = r[n],
    ...
    function H(e) {
        ...
        if ((o.originalEvent && (o = o.originalEvent), t.isTouched)) {
            if (!t.isTouchEvent || "touchmove" === o.type) {
                ...
                if (
                    (t.allowTouchCallbacks && this.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1))
                ) {
                        ...
                        if (
                            ...
                            (this.allowClick = !1), !s.cssMode && o.cancelable && o.preventDefault(),
                                ...
                                (s.loop && this.loopFix(),
                                    ...
                                    (t.allowMomentumBounce = !1), !s.grabCursor ||
                                ...
                                (s.touchReleaseOnEdges && (g = 0),
                                    ...
                                    ((m = !1),
                                        ...
                                        (t.currentTranslate =
                                            this.minTranslate() -
                                            1 +
                                            Math.pow(-this.minTranslate() + t.startTranslate + f,
                                                g
                                            ))) :
                                    f < 0 &&
                                    ...
                                    m && (o.preventedByNestedSwiper = !0), !this.allowSlideNext &&
                                    "next" === this.swipeDirection &&
                                    t.currentTranslate < t.startTranslate &&
                                    (t.currentTranslate = t.startTranslate), !this.allowSlidePrev &&
    ...
    function B(e) {
        ...
        if (
            ...
            if (s.freeMode) {
                ...
                for (
                    var k = 0, $ = t.slidesSizesGrid[0], L = 0; L < o.length; L += L < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup
                ) {
    ...
    function V() {
        ...
        this.isHorizontal() ?
            (this.translate = t ?
                ...
                -e.scrollLeft) :
            (this.translate = -e.scrollTop), -0 === this.translate && (this.translate = 0),
                ...
                preloadImages: function() {
                    ...
                    for (var i = 0; i < e.imagesToLoad.length; i += 1) {
                        ...
                        e.loadImage(
                            ...
                            s.sizes || s.getAttribute("sizes"), !0,
                            t
                        );
                    }
                },
        ...
        j = (function(e) {
            ...
            return (
                (t.prototype.slidesPerViewDynamic = function() {
                    ...
                    if (e.centeredSlides) {
                        for (
                            var n, o = t[a].swiperSlideSize, l = a + 1; l < t.length; l += 1
                        )
                            t[l] &&
                            !n &&
    ...
    var re = {
            ...
            handle: function(e) {
                ...
                if (
                    ("container" !== i.params.mousewheel.eventsTarged &&
                        (a = n(i.params.mousewheel.eventsTarged)), !i.mouseEntered && !a[0].contains(t.target) && !s.releaseOnEdges)
                )
                    return !0;
            ...
            animateSlider: function(e) {
                return (
                    ...
                    (e.direction < 0 ?
                        ...
                        (this.mousewheel.lastScrollTime = new a.Date().getTime()), !1)
                );
            },
                ...
                if ((i.transition(e), t.params.virtualTranslate && 0 !== e)) {
                    ...
                    i.transitionEnd(function() {
                        if (!a && t && !t.destroyed) {
                            (a = !0), (t.animating = !1);
                            for (
                                var e = ["webkitTransitionEnd", "transitionend"], i = 0; i < e.length; i += 1
                            )
                                s.trigger(e[i]);
                        }
                    });
        ...
        we = {
            setTranslate: function() {
                for (
                    var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1
                ) {
                    var s = e.eq(i),
                        a = s[0].progress;
                    ...
                    click: function(e) {
                        ...
                        !this.params.navigation.hideOnClick ||
                            ...
                            (s ?
                                ...
                                a && (t = a.hasClass(this.params.navigation.hiddenClass)), !0 === t ?
