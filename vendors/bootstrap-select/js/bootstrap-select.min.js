    ...
    !(function(T) {
        ...
        function P(e, t, i) {
            ...
            for (var s = Object.keys(t), n = 0, o = e.length; n < o; n++)
                for (
                    var l = e[n].querySelectorAll("*"), r = 0, a = l.length; r < a; r++
                ) {
                    var c = l[r],
        ...
        function z(e) {
            for (
                var t, i = [], s = e || A.call(this), n = 0, o = s.length; n < o; n++
            )
        ...
        function k(e, t, i, s) {
            for (
                var n = ["display", "subtext", "tokens"], o = !1, l = 0; l < n.length; l++
            ) {
                var r = n[l],
                    a = e[r];
                if (
        ...
        (te.prototype = {
                ...
                for (var e = 0; e < this.selectpicker.current.data.length; e++) {
                    ...
                    "divider" === t.type ?
                        ...
                        (this.selectpicker.view.size++,
                            (t.posinset = this.selectpicker.view.size), !1 === this.selectpicker.view.firstHighlightIndex &&
                    ...
                    if (
                        ...
                        if (
                            ((c = N.selectpicker.view.visibleElements ?
                                    ...
                                    []),
                                (N.selectpicker.view.visibleElements = !1 === u ?
                            ...
                            if (
                                (N.options.sanitize &&
                                    k.length &&
                                    P(k, N.options.whiteList, N.options.sanitizeFn), !0 === u ?
                                    ((v =
                                    ...
                                    b.firstChild.appendChild(w), !0 === u && N.sizeInfo.hasScrollBar)
                            ) {
                ...
                if (e) {
                    ...
                    s &&
                        (s.setAttribute("aria-setsize", this.selectpicker.view.size),
                            s.setAttribute("aria-posinset", t.posinset), !0 !== i &&
                    ...
                    (this.options.dropupAuto &&
                        ((r = d * this.selectpicker.current.data.length + v.vert),
                            (a =
                                ...
                                this.sizeInfo.selectOffsetBot), !0 === this.selectpicker.isSearching &&
            ...
            setOptionStatus: function(e) {
                ...
                if (
                    ...
                    for (
                        var i = 0; i < t.selectpicker.view.visibleElements.length; i++
                    ) {
                        var s =
                    ...
                    this.$menuInner.on("click", "li a", function(e, t) {
                        ...
                        if (
                            (O.multiple &&
                                ...
                                e.stopPropagation(),
                                e.preventDefault(), !O.isDisabled() && !i.parent().hasClass(G.DISABLED))
                        ) {
                            var p = o.option,
                                u = T(p),
                                f = p.selected,
                            ...
                            O.options.source.data &&
                                O.$element[0].appendChild(O.selectpicker.main.optionQueue), !O.multiple || (O.multiple && 1 === O.options.maxOptions) ?
            ...
            val: function(t) {
                ...
                if (
                    (this.selectpicker.main.data.filter(function(e) {
                            return (-1 !== t.indexOf(String(e.value)) &&
            ...
            changeAll: function(e) {
                if (this.multiple) {
                    ...
                    t.classList.add("bs-select-hidden");
                    for (
                        var o = 0, l = this.selectpicker.current.data, r = l.length; o < r; o++
                    ) {
                        var a = l[o],
                            c = a.option;
                        c &&
