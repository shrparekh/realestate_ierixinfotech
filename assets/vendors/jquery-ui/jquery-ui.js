...
(function(factory) {
        ...
        $.position = {
            ...
            getWithinInfo: function(element) {
                ...
                return {
                    ...
                    width: isWindow || isDocument ?
                        withinElement.width() :
                        withinElement.outerWidth(),
                    height: isWindow || isDocument ?
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function() {
            ...
            this.isMultiLine =
                ...
                isTextarea ?
                true : // Inputs are always single-line, even if inside a contentEditable element
                // IE also treats inputs as contentEditable
                isInput ?
                false : // All other element types are determined by whether or not they're contentEditable
    ...
    var effectBounce = ($.effects.effect.bounce = function(o, done) {
        ...
        if (queuelen > 1) {
            queue.splice.apply(
                queue, [1, 0].concat(queue.splice(queuelen, anims + 1))
            );
        }
        el.dequeue();
    });
